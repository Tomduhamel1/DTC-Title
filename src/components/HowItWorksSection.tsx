...
export default function HowItWorksSection() {
  ...
  const steps = [
    ...
    },
    {
      ...
      description:
        "Watch your closing happen in real time. Every milestone — title ordered, title search complete, title issued, closed — updates as parties and services fill in.",
      icon: (
        <svg className="w-12 h-12 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
