          ...
          {testimonials.map((testimonial, index) => (
            <div key={index} className="bg-white rounded-xl shadow-lg p-6 hover:shadow-xl transition-shadow border border-gray-100">
                ...
                <div>
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    {testimonial.type === "Verified Buyer" && (
                      <div className="inline-flex items-center gap-1 bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded-full text-xs font-semibold">
              ...
              <div className="flex items-center justify-between pt-4 border-t border-gray-100">
                {testimonial.savings && (
                  <div className="inline-block bg-emerald-50 text-emerald-700 px-3 py-1.5 rounded-lg font-bold text-sm">
