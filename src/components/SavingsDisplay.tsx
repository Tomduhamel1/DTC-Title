...
export default function SavingsDisplay({ savings, isUpdating = false }: SavingsDisplayProps) {
  ...
  return (
    <div className={`bg-gradient-to-br from-emerald-50 to-emerald-50 rounded-xl p-6 shadow-lg border-2 border-emerald-200 transition-all duration-300 ${
      isUpdating ? 'scale-105 shadow-xl' : ''
    }`}>
      {/* Main Savings Number */}
      <div className="text-center mb-4">
        <div className="text-sm font-semibold text-emerald-700 mb-1">ESTIMATED SAVINGS</div>
        <div className={`text-6xl font-black text-emerald-600 mb-2 transition-all duration-500 ${
      ...
      {isUpdating && (
        <div className="mt-4 text-center">
          <div className="inline-flex items-center gap-2 text-xs font-semibold text-emerald-700 bg-emerald-100 px-3 py-1 rounded-full">
