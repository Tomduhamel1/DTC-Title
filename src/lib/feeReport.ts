...
export function getSampleFeeReport(): FeeReport {
  return {
    ...
    lineItems: [
      ...
      {
        // Settlement carries the whole verified package delta (market-
        // comparison model 2026-08-11); other service lines sit at parity.
        id: 'settlement-fee',
        label: 'Settlement Fee',
        category: 'title-settlement',
        ourCost: 350,
        isFixed: false,
        typicalRange: { low: 350, high: 455 },
        feeSource: 'service',
