...
export const GENERATED_AT = '2026-07-22T17:22:42.051Z'
...
export const NATIONAL_ANCHOR: StateAnchor = { purchase: { save: 441, ourTotal: 4515 }, refinance: { save: 215, ourTotal: 2043 } }

export const STATE_ANCHORS: Record<string, StateAnchor> = {
  AK: { purchase: { save: 538, ourTotal: 3505 }, refinance: { save: 474, ourTotal: 2535 } },
  ...
  CA: { purchase: { save: 532, ourTotal: 2116 }, refinance: { save: 294, ourTotal: 1433 } },
  CO: { purchase: { save: 187, ourTotal: 1469 }, refinance: { save: 208, ourTotal: 1296 } },
  CT: { purchase: { save: 597, ourTotal: 3524 }, refinance: { save: 407, ourTotal: 2308 } },
  DC: { purchase: { save: 920, ourTotal: 12065 }, refinance: { save: 163, ourTotal: 1270 } },
  ...
  HI: { purchase: { save: 674, ourTotal: 3277 }, refinance: { save: 496, ourTotal: 2368 } },
  ...
  MI: { purchase: { save: 379, ourTotal: 2162 }, refinance: { save: 172, ourTotal: 1170 } },
  MN: { purchase: { save: 474, ourTotal: 3530 }, refinance: { save: 139, ourTotal: 2032 } },
  MO: { purchase: { save: 157, ourTotal: 1339 }, refinance: { save: 77, ourTotal: 850 } },
  ...
  NJ: { purchase: { save: 39, ourTotal: 3425 }, refinance: { save: 26, ourTotal: 1945 } },
  NM: { purchase: { save: 95, ourTotal: 4025 }, refinance: { save: 26, ourTotal: 2645 } },
  NV: { purchase: { save: 671, ourTotal: 3952 }, refinance: { save: 161, ourTotal: 1149 } },
  NY: { purchase: { save: 0, ourTotal: 12170 }, refinance: { save: 0, ourTotal: 10609 } },
  OH: { purchase: { save: 23, ourTotal: 2240 }, refinance: { save: 26, ourTotal: 1339 } },
  OK: { purchase: { save: 493, ourTotal: 4835 }, refinance: { save: 232, ourTotal: 2862 } },
  OR: { purchase: { save: 450, ourTotal: 3327 }, refinance: { save: 450, ourTotal: 2512 } },
  ...
  UT: { purchase: { save: 386, ourTotal: 2206 }, refinance: { save: 236, ourTotal: 1446 } },
  ...
  WY: { purchase: { save: 442, ourTotal: 2560 }, refinance: { save: 177, ourTotal: 1306 } },
}
