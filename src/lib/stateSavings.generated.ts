...
export const GENERATED_AT = '2026-07-25T19:39:34.287Z'
...
export const NATIONAL_ANCHOR: StateAnchor = { purchase: { save: 449, ourTotal: 4515 }, refinance: { save: 194, ourTotal: 2043 } }
...
export const STATE_ANCHORS: Record<string, StateAnchor> = {
  ...
  CA: { purchase: { save: 1148, ourTotal: 2116 }, refinance: { save: 324, ourTotal: 1433 } },
  ...
  GA: { purchase: { save: 799, ourTotal: 5519 }, refinance: { save: 137, ourTotal: 2324 } },
  ...
  IL: { purchase: { save: 1513, ourTotal: 5334 }, refinance: { save: 100, ourTotal: 1214 } },
  ...
  WA: { purchase: { save: 434, ourTotal: 2193 }, refinance: { save: 367, ourTotal: 1863 } },
